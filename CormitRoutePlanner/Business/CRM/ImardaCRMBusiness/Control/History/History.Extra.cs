...
namespace ImardaCRMBusiness
{
	partial class ImardaCRM
	{
		...
		private string GetFilteredHistoryExtentSQL(int scope, int startRow, int endRow, string whereClause, string sortClause)
		{
			var database = "CRM";
		...
		public GetListResponse<History> GetHistoryListByContactID(IDRequest request)
		{
			var response = new GetListResponse<History>();
			try
			{
				...
				var spName = "SPGetHistoryListByContactID";
		...
		public GetListResponse<History> GetHistoryListByJobID(IDRequest request)
		{
			var response = new GetListResponse<History>();
			try
			{
				var db = ImardaDatabase.CreateDatabase(Util.GetConnName<History>());
				bool includeInactive = request.HasSome(RetrievalOptions.IncludeInactive);
				var spName = "SPGetHistoryListByJobID";
				using (IDataReader dr = db.ExecuteDataReader(spName, includeInactive, request.CompanyID, request.ID))
				{
					response.List = new List<History>();
					while (dr.Read())
		...
		public GetListResponse<History> GetHistoryListByTaskID(IDRequest request)
		{
			var response = new GetListResponse<History>();
			try
			{
				var db = ImardaDatabase.CreateDatabase(Util.GetConnName<History>());
				bool includeInactive = request.HasSome(RetrievalOptions.IncludeInactive);
				var spName = "SPGetHistoryListByTaskID";
				using (IDataReader dr = db.ExecuteDataReader(spName, includeInactive, request.CompanyID, request.ID))
				{
					response.List = new List<History>();
					while (dr.Read())
		...
		public GetListResponse<History> GetHistoryListByUserID(IDRequest request)
		{
			var response = new GetListResponse<History>();
			try
			{
				var db = ImardaDatabase.CreateDatabase(Util.GetConnName<History>());
				bool includeInactive = request.HasSome(RetrievalOptions.IncludeInactive);
				var spName = "SPGetHistoryListByUserID";
				using (IDataReader dr = db.ExecuteDataReader(spName, includeInactive, request.CompanyID, request.ID))
				{
					response.List = new List<History>();
					while (dr.Read())
