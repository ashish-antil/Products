...
{
	[DataContract]
	public class IncidentConfigurationChangeLog : FullBusinessEntity 
	{			
		#region Constructor	
		public IncidentConfigurationChangeLog()
		{
		}
		#endregion
		...
		[DataMember] public byte DeviceType { get; set; }

		[DataMember] public string Filename { get; set; }

		[DataMember] public Guid FileID { get; set; }

		[DataMember] public DateTime FileCreationDate { get; set; }

		[DataMember] public DateTime FileModificationDate { get; set; }
